"""
Django settings for not_announced_44000 project.
...
ROOT_URLCONF = 'not_announced_44000.urls'
...
WSGI_APPLICATION = 'not_announced_44000.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "not_announced_44000 API",
    "DESCRIPTION": "API documentation for not_announced_44000 App",
    "VERSION": "v1",
}
